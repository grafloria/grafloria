...
export class StyleParser {
    ...
    parseStyleProperties(text) {
        ...
        for (const declaration of declarations) {
            ...
            if (parsedValue !== undefined) {
                properties[camelProperty] = parsedValue;
            }
        }
        return properties;
    }
     ...
     */
    parseStyleValue(property, value) {
        // Boolean properties
     ...
     */
    extractStyleClasses(nodeDefinition) {
     ...
     */
    extractInlineStyle(nodeDefinition) {
        const styleRegex = /\{([^}]+)\}$/;
     ...
     */
    stripStyleSyntax(nodeDefinition) {
