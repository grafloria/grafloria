...
/** Dagre layered layout, declaratively: every node starts at 0,0 and layout
 *  arranges the tree — including the isolated node b2. */
export default function DagreTreeDemo() {
  useEffect(() => markReady(), []);
  return (
