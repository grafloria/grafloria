...
/** Cards taller than their content should be: a fixed `height` caps the card
 *  and the kit body scrolls — shown on a 21-column ER table and a 26-member UML
 *  class. */
export default function ScrollableCardsDemo() {
  useEffect(() => markReady(), []);
  return (
