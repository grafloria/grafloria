...
// gravity packing, wide cells, pinned widgets and a dense mix — all through the
// same :options the kit exposes.
...
<template>
  <div style="height:100vh">
    <GrafloriaDashboard :views="views" :options="options" v-model:active-view="tab" />
  </div>
</template>
