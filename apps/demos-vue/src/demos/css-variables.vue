...
<template>
  <div style="display:flex;height:100vh">
    <div style="flex:1;min-width:0;position:relative;border-right:1px solid rgba(127,127,127,.3)">
      ...
      <GrafloriaFlow :default-nodes="a.nodes" :default-edges="a.edges" :theme="light" style="display:block;height:100%" />
    </div>
    <div style="flex:1;min-width:0;position:relative">
      ...
      <GrafloriaFlow :default-nodes="b.nodes" :default-edges="b.edges" :theme="dark" style="display:block;height:100%" />
    </div>
  </div>
</template>
