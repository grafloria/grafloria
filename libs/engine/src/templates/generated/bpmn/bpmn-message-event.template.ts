/**
 * Auto-generated NodeTemplate for bpmn-message-event
 * Generated from TypeRegistry entry: bpmn:message-event
 *
...
export const bpmnMessageEventTemplate: NodeTemplate = {
